...
class _CustomRangeSliderState extends State<CustomRangeSlider> with TickerProviderStateMixin {
  ...
  Thumb? _defaultRangeThumbSelector(
    ...
    final double touchRadius = math.max(thumbSize.width, CustomRangeSlider._minTouchTargetWidth) / 2;
  ...
  Widget build(BuildContext context) {
    ...
    const RangeSliderTrackShape _defaultTrackShape = _RoundedRectRangeSliderTrackShape1();
